...
JWB.messages.en = {
	...
	'label-limits':			'Limits',
	'tip-time-limit':		'The time limit for any given (RegEx) match rule is allowed to run in milliseconds; applies to both replacing AND skip rules.',
	...
	'summary-suffix':		' (via $1)', //$1 represents either wiki- or HTML-link
	'watch-add':			'Add now',
	...
	'save-interval-label':	'every',
	'save-interval-unit':	'sec',
	'tip-save-interval':	'Amount of seconds to pause between each edit',
	'label-edit-actions':	'Actions',
	...
	'label-find-replace':	'Find & replace',
	...
	'skip-after-action':	'after move/protect',
	'label-skip-checks':	'Or when:',
	...
	'log-action-note':		"See 'Edit' tab to change summary.",
	'act-also':				'Also act on:',
	'act-talk-page':		'talk page',
	'act-subpage':			'subpages',
